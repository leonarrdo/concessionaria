...
export default function ApplicationLayout({ user, header, children }: PropsWithChildren<AuthenticatedProps>) {
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink href={route('vehicle.edit')} active={route().current('vehicle.edit')}>
                                    <p className="font-bold text-black">Editar Veículos</p>
                                </NavLink>
                        ...
                        <div className="hidden sm:flex sm:items-center sm:ms-6">
                            {user ? (
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <Link href={route('register')} className="text-gray-500 hover:text-gray-700">
                                        Cadastro
                                    </Link>
                                </div>
                            )}
